...
mixin _$AuthWatcherEvent {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult authReceived(Option<QuizUser> userOption),
    @required TResult signedOut(QuizUser user),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult authCheckRequested(),
    TResult authReceived(Option<QuizUser> userOption),
    TResult signedOut(QuizUser user),
...
mixin _$AuthWatcherState {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult authenticated(QuizUser user),
    @required TResult unauthenticated(),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult initial(),
    TResult authenticated(QuizUser user),
